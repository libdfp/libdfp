...
/* These are subtley different depending on how the C library may have
 * defined them. */
#ifndef FP_LLOGB0
# if defined (__FP_LOGB0_IS_MIN) && __FP_LOGB0_IS_MIN
...
#endif
#ifndef FP_LLOGBNAN
# if defined (__FP_LOGBNAN_IS_MIN) && __FP_LOGBNAN_IS_MIN
