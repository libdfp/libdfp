...
d64_type d64[] =
{
  DEC128_TEST (1E0DD,     1,   1E1DD),
  DEC128_TEST (1E0DD,    10,  1E10DD),
  DEC128_TEST (1E0DD,   100, 1E100DD),
  DEC128_TEST (1E100DD,   0,   1E0DD),
  DEC128_TEST (1E10DD,    0,   1E0DD),
  DEC128_TEST (1E1DD,     0,   1E0DD),
  DEC128_TEST (9999999999999999E0DD,      1,
	       9999999999999999E1DD),
  DEC128_TEST (9999999999999999E0DD,     10,
	       9999999999999999E10DD),
  DEC128_TEST (9999999999999999E0DD,    100,
...
d32_type d32[] =
{
  DEC128_TEST (1E0DF,     1,   1E1DF),
  DEC128_TEST (1E0DF,    10,  1E10DF),
  DEC128_TEST (1E0DF,    90,  1E90DF),
  DEC128_TEST (1E90DF,    0,   1E0DF),
  DEC128_TEST (1E10DF,    0,   1E0DF),
  DEC128_TEST (1E1DF,     0,   1E0DF),
  DEC128_TEST (9999999E0DF,      1,
	       9999999E1DF),
  DEC128_TEST (9999999E0DF,     10,
	       9999999E10DF),
  DEC128_TEST (9999999E0DF,     90,
	       9999999E90DF)
};
